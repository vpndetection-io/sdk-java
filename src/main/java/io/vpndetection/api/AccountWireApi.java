...
import io.vpndetection.model.Identity;
...
public class AccountWireApi {
   ...
   */
  public Identity accountIdentity() throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public Identity accountIdentity(Map<String, String> headers) throws ApiException {
    ApiResponse<Identity> localVarResponse = accountIdentityWithHttpInfo(headers);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Identity> accountIdentityWithHttpInfo() throws ApiException {
    return accountIdentityWithHttpInfo(null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Identity> accountIdentityWithHttpInfo(Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = accountIdentityRequestBuilder(headers);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("accountIdentity", localVarResponse);
        }
  ...
  private HttpRequest.Builder accountIdentityRequestBuilder(Map<String, String> headers) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/api/v1/iam/identity";
